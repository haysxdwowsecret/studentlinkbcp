class Concern {
  ...
  factory Concern.fromJson(Map<String, dynamic> json) {
    return Concern(
      ...
      student: json['student'] != null ? StudentInfo.fromJson(json['student']) : StudentInfo(id: 0, name: '', displayId: ''),
      department: json['department'] != null ? DepartmentInfo.fromJson(json['department']) : DepartmentInfo(id: 0, name: '', code: ''),
...
class ConcernMessage {
  ...
  factory ConcernMessage.fromJson(Map<String, dynamic> json) {
    return ConcernMessage(
      ...
      type: json['type'] ?? '',
      author: json['author'] != null ? AuthorInfo.fromJson(json['author']) : AuthorInfo(id: 0, name: '', role: ''),
      attachments: List<String>.from(json['attachments'] ?? []),
