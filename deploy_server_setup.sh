...
apt install -y nginx mysql-server php8.3-fpm php8.3-mysql php8.3-xml php8.3-mbstring php8.3-curl php8.3-zip php8.3-bcmath php8.3-gd php8.3-intl php8.3-cli php8.3-common php8.3-opcache php8.3-readline php8.3-sqlite3 php8.3-tokenizer php8.3-xmlrpc php8.3-xsl php8.3-redis
