...
export default function FacultyConcernsPage() {
  const [selectedConcern, setSelectedConcern] = useState<any>(null)
  const [replyText, setReplyText] = useState("")

  // Mock data for student concerns
  const concerns = [
    {
      id: 1,
      title: "Difficulty Understanding Programming Concepts",
      student: "John Dela Cruz",
      course: "CS101 - Introduction to Programming",
      status: "received",
      priority: "medium",
      date: "2024-01-15",
      description: "I'm having trouble understanding loops and arrays. Could you provide additional examples?",
      replies: [],
    },
    {
      id: 2,
      ...
      priority: "high",
      date: "2024-01-14",
      description: "Unable to submit assignment through the portal. Getting error message.",
      replies: [
        { author: "Prof. Garcia", message: "I'll check with IT support about this issue.", date: "2024-01-14" },
      ],
    },
    {
      id: 3,
      title: "Request for Make-up Exam",
      student: "Anonymous",
      course: "CS103 - Database Systems",
      status: "received",
      priority: "high",
      date: "2024-01-13",
      description: "I was sick during the midterm exam. Can I take a make-up exam?",
      replies: [],
    },
  ]
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-white shadow-sm border-b border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-[#1E2A78]">Student Concerns</h1>
              <p className="text-gray-600">Manage concerns from your students</p>
            </div>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <CardDescription className="mt-1">
                          From: {concern.student} • {concern.course}
                        </CardDescription>
                      </div>
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        {selectedConcern.course} • {selectedConcern.date}
                      </p>
                    </div>
