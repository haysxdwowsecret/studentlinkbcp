...
import { ChevronLeft, ChevronRight, TrendingUp, Users, MessageSquare } from 'lucide-react'
...
export const InstitutionalCarousel: React.FC = () => {
  ...
  const goToPrevious = () => {
    setCurrentIndex(currentIndex === 0 ? institutionalContent.length - 1 : currentIndex - 1)
    setIsAutoPlaying(false)
  }

  const goToNext = () => {
    setCurrentIndex(currentIndex === institutionalContent.length - 1 ? 0 : currentIndex + 1)
    setIsAutoPlaying(false)
  }
